...
> - **(check)** Payment and information: Payments are handled via Paddle. We do not store payment data ourselves (eg. credit card information). Only data such as the next payment date, the amount and currency of the next payment and similar, non-personal information is stored on our side.
...
* Telemetry data: We collect anonymized telemetry data in our Firecamp app. For more details, read our [telemetry documentation](https://kreya.app/docs/telemetry/).
